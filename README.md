...
2. [Presentation](House_Recommendations_for _Jacob Phillip.pptx): This file contains the final presentation of the EDA project. It summarizes the hypothesis and recommendations for the client. 
